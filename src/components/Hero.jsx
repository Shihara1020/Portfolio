      ...
      >
        ...
        <div className="flex flex-col justify-center items-start ">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm
            <span className="text-[#915eff]"> Shihara </span>
          </h1>

          <p className="mt-10">
            <img
              src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=30&duration=2000&pause=2000&color=F7E976&width=1500&lines=Computer+Engineering+Student+%7C%7C+University+of+Peradeniya"
              alt="Typing SVG"
            />
          </p>
          <p className="mt-10 text-2xl">
            2nd<span className=" text-3xl text-[#F7E976]">Year </span>{" "}
            Computer Science Engineer
          </p>
          <div className="container mx-auto">
            <div className="flex gap-5 mt-10 sm:gap-10">
              <Link to={"https://github.com/Shihara1020"}>
